   ...
   <nav class="navi_wrap">
					...
					<ul class="navi">
						...
						<li><a href="solution_Adrive" class="depth1 on">SOLUTION</a>
							<ul class="depth2">
								...
								<li class="on"><a href="solution_ST_framework">ST Framework</a></li>
				...
				<c:if test="${level == 1 }">
					<ul class="navi">
						...
						<li><a href="#" class="depth1 on">SOLUTION</a><a class="depth1"><i
								class="far fa-edit"></i></a>
							<ul class="depth2">
								<li><a href="solution_Adrive">A.Drive</a></li>
								<li class="on"><a href="solution_ST_framework">ST Framework</a></li>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <div class="img_div"><img src="resources/static/images/st_framework_01.jpg" alt=""></div>
              </div>
