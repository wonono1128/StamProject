	...
	<div id="container">
		...
		<div id="login_div">
			<form id="login_form" action="./loginChk" method="post">
				<h2>Login</h2>
				<div id="div_id">
					<input id="manager_db_id" name="manager_db_id" value=""> <input
						id="manager_id" name="managerId" placeholder="관리자 아이디를 입력하세요">
				</div>
				<div id="div_pw">
					<input type="password" id="manager_pw" name="managerPw"
						placeholder="관리자 비밀번호를 입력하세요"> <br>
				</div>
