      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resources/static/images/portfolio/portfolio_2021_2.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resources/static/images/portfolio/portfolio_2021_3.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resources/static/images/portfolio/portfolio_2021_4.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resources/static/images/portfolio/portfolio_2021_5.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
...
<div class="modal" id="portfolio2021_2">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resources/static/images/portfolio/portfolio_2021_2.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2021_3">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resources/static/images/portfolio/portfolio_2021_3.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2021_4">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resources/static/images/portfolio/portfolio_2021_4.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2021_5">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resources/static/images/portfolio/portfolio_2021_5.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
