								...
								<table class="notice_table">
									...
									<tr class="notice-insert-tr">
										...
										<td colspan="2"><textarea placeholder="내용을 입력해주세요"
												name="noticeContents" id="notice_insert_text" required
												minlength="20" onkeyup="fn_checkByte(this)"></textarea> <sup>(<span
												id="nowByte">0</span>/1000bytes)
										</sup></td>
									</tr>
									<tr class="notice_insert_tr notice_insert_btn">

										<td class="notice_insert_input"><button
												id="notice_insert_btn">추가</button></td>
