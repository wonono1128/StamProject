        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <h4>ORGANIZATION</h4>
                <div class="img_div mb30"><img src="resources/static/images/img_organ1.jpg" alt=""></div>

                <h4>STABILITY</h4>
                <div class="img_div"><img src="resources/static/images/img_organ2.jpg" alt=""></div>
              </div>
            </div>
          </div>
          <div class="num_div">
...
<script type="text/javascript" src="resources/static/plugins/swiper/swiper-bundle.min.js"></script>
