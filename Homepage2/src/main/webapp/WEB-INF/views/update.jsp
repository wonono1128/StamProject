          ...
          <div class="notice-div">
          	...
          	<form method="post"action="update_ok" >
	       		<table class="notice-table">
	       			<tr>
	       				<td><input style="display:none" type="text"  name="nid" value="${ndto.nid }"></td>
	       			</tr>
	       			<tr>
	       				<td>제목</td>
	       				<td><input type="text"  name="ntitle" value="${ndto.ntitle }"></td>	
	       			</tr>
	       			<tr>
	      			 	<td>내용</td>
	       				<td><textarea  name="ncontent" >${ndto.ncontent }</textarea></td>	
	       			</tr>
