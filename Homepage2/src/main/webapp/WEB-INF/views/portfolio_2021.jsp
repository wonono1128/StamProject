      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          <div class="subtitle_section item">
            ...
            <div class="description">
              <p>제안/상담부터 제품 개발까지<br>
                ...
                제품 개발 프로세스에 따른<br>
                체계적인 정보관리</p>
              <p class="logo_img_div"><img src="resource/images/portfolio/logo_cj.png" alt="CJ 로고"></p>
            </div>
          </div>
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2021_1.jpg" alt="">
              </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            <div class="tit_div s_num_div">
              <span class="s_num s_num2021"></span>
              <a href="javascript:void(0);" class="btn_open mo" data-target="portfolio2021_2"></a>
            </div>
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2021_2.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            <div class="tit_div s_num_div">
              <span class="s_num s_num2021"></span>
              <a href="javascript:void(0);" class="btn_open mo" data-target="portfolio2021_3"></a>
            </div>
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2021_3.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            <div class="tit_div s_num_div">
              <span class="s_num s_num2021"></span>
              <a href="javascript:void(0);" class="btn_open mo" data-target="portfolio2021_4"></a>
            </div>
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2021_4.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            <div class="tit_div s_num_div">
              <span class="s_num s_num2021"></span>
              <a href="javascript:void(0);" class="btn_open mo" data-target="portfolio2021_5"></a> <!-- 수정 -->
            </div>
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2021_5.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
  ...
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        ...
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2021_1.jpg" alt=""></div>
      </div>
    </div>
...
<div class="modal" id="portfolio2021_2">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2021_2.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2021_3">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2021_3.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2021_4">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2021_4.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2021_5">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2021"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2021_5.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
