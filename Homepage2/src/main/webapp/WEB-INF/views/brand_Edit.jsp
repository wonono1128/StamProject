        ...
        <div class="swiper-slide">
          ...
          <div class="subtitle_section item">
            ...
            <div class="description">
              ...
              <p class="logo_img_div"><img src="resource/images/portfolio/logo_hyosung.png" alt="효성 로고"></p>
            </div>
          </div>
          <div class="contents item Edit">
            ...
            <div class="cont">
              <div class="conts_div">
                <div class="img_div"><img src="resource/images/edit_01.jpg" alt=""></div>
              </div>
          ...
          <div class="subtitle_section item">
            ...
            <div class="description">
              <p>기존에 고전적인 스타일에서 탈바꿈을 시도하여<br>
                ...
                잡아가며 변화를 유도하였습니다.</p>
               <p class="logo_img_div"><img src="resource/images/portfolio/logo_nationalopera.png" alt="국립오페라단 로고"></p>
            </div>
          </div>
          <div class="contents item Edit">
            <div class="tit_div tit_div2">
            ...
            <div class="cont">
              <div class="conts_div">
                <div class="img_div"><img src="resource/images/edit_02.jpg" alt=""></div>
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="subtitle_section item">
            ...
            <div class="description">
              ...
              <p class="logo_img_div"><img src="resource/images/portfolio/logo_seoulUniv.png" alt="서울대학교 로고"></p>
            </div>
          </div>
          <div class="contents item Edit">
            <div class="tit_div tit_div2">
            ...
            <div class="cont">
              <div class="conts_div">
                <div class="img_div"><img src="resource/images/edit_03.jpg" alt=""></div>
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
