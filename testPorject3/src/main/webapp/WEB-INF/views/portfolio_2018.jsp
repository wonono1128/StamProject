    ...
    <nav class="navi_wrap">
      <ul class="navi">
        <li>
          ...
          <ul class="depth2">
            <li><a href="#">Intro + Vision & Business</a></li>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          <div class="subtitle_section item">
            ...
            <div class="description">
              ...
              공격적인 차별화 전략을 수행</p>
              <p class="logo_img_div"><img src="resource/images/portfolio/logo_dalim.png" alt="대림B&Co 로고"></p>
            </div>
          </div>
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2018_1.jpg" alt="">
              </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2018_2.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2018_3.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="subtitle_section item">
            ...
            <div class="description">
              ...
              <p class="logo_img_div"><img src="resource/images/portfolio/logo_samsung.png" alt="삼성 로고">
              </p>
            </div>
          </div>
          <div class="contents item">
            ...
            <div class="cont">
              <div class="conts_div">
                <img src="resource/images/portfolio/portfolio_2018_4.jpg" alt="">
              </div>
              <a href="#" class="mo close_layer">닫기</a>
            </div>
          </div>
  ...
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        ...
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2018_1.jpg" alt=""></div>
      </div>
    </div>
...
<div class="modal" id="portfolio2018_2">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2018"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2018_2.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2018_3">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2018"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2018_3.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
...
<div class="modal" id="portfolio2018_4">
  <div class="modal_wrap">
    <div class="modal_cont">
      <div class="m_content">
        <div class="s_num_div mo"><span class="s_num s_num2018"></span></div>
        <div class="img_div"><img src="resource/images/portfolio/portfolio_2018_4.jpg" alt=""></div>
      </div>
    </div>
    <button class="modal_close"></button>
  </div>
